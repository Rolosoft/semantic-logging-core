...
namespace Rolosoft.Practices.EnterpriseLibrary.SemanticLogging.Etw.Configuration
{
    ...
    public class ConfigurationException : Exception, ISerializable
    {
        ...
        public ConfigurationException()
            : this(Resources.TraceEventServiceConfigurationExceptionDefaultMessage)
        {
        }
        ...
        public ConfigurationException(params Exception[] innerExceptions)
            : this(Resources.TraceEventServiceConfigurationExceptionDefaultMessage, innerExceptions)
        {
        }
        ...
        public override string ToString()
        {
            ...
            {
                sb.AppendFormat(Resources.TraceEventServiceConfigurationFileFormat, this.ConfigurationFile);
                sb.AppendLine();
            }
        ...
        private static string ExtendedMessage(Exception e)
        {
            ...
            if (xsdValidation != null)
            {
                return string.Format(CultureInfo.CurrentCulture,
                                     Resources.XmlSchemaValidationExceptionFormat,
        ...
        {
            return message.Replace(string.Format(CultureInfo.CurrentCulture, Resources.RemoveNamespaceFromErrrMessage, Constants.Namespace), string.Empty);
        }
    }
}
