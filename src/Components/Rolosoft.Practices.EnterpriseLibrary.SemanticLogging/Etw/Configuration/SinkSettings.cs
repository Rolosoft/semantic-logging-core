...
namespace Rolosoft.Practices.EnterpriseLibrary.SemanticLogging.Etw.Configuration
{
    ...
    public class SinkSettings
    {
        ...
        private SinkSettings(string name, IEnumerable<EventSourceSettings> eventSources)
        {
            ...
            {
                throw new ConfigurationException(string.Format(CultureInfo.CurrentCulture, Resources.NoEventSourcesError, name));
            }
            ...
            {
                throw new ConfigurationException(string.Format(CultureInfo.CurrentCulture, Resources.DuplicateEventSourceNameError, duplicateByName.First().Name, name));
            }
            ...
            {
                throw new ConfigurationException(string.Format(CultureInfo.CurrentCulture, Resources.DuplicateEventSourceIdError, duplicateById.First().Name, name));
            }
