...
namespace Rolosoft.Practices.EnterpriseLibrary.SemanticLogging.Tests.Etw
{
    ...
    public class given_sinkSettings
    {
        ...
        {
            new Rolosoft.Practices.EnterpriseLibrary.SemanticLogging.Etw.Configuration.SinkSettings(null, new InMemoryEventListener(), Enumerable.Empty<Rolosoft.Practices.EnterpriseLibrary.SemanticLogging.Etw.Configuration.EventSourceSettings>());
        }
